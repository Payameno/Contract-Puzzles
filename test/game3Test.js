...
describe('Game3', function () {
  async function deployContractAndSetVariables() {
    ...
    const user3 = ethers.provider.getSigner(2);
    ...
    return { game, signer, user2, user3, address1, address2, address3 };
  }

  it('should be a winner', async function () {
    const { game, signer, user2, user3, address1, address2, address3 } = await loadFixture(deployContractAndSetVariables);
